        ...
        <div className="w-[100%] h-auto border-y border-slate-200 flex justify-start items-center ">
          ...
          <div className="w-[20%] p-2 border-r border-slate-200">
            <section className="flex justify-start items-center gap-2">
              <Link href='#'><AiFillEye className="text-xl text-blue-600 hover:text-blue-700 " /></Link>
              <Link href='#'><AiFillEdit className="text-xl text-green-600 hover:text-green-700 " /></Link>
              <Link href='#'><AiFillDelete className="text-xl text-red-600 hover:text-red-700 " /></Link>
            </section>
          </div>
        </div>
        {/* TABLE ROW */}
