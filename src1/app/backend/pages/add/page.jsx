...
function Add() {
  ...
  return (
    <div className="w-[100%] h-auto pt-4 bg-slate-100 overflow-auto">
      {/*  */}
      <section className="px-8 bg-slate-50">
        <h1 className="font-semibold text-[3.5rem] pb-4">{pageName}</h1>
      </section>
      {/*  */}
      <section className='w-[100%] h-auto bg-white px-8 py-4 drop-shadow-md'>
        <h4 className='font-bold text-2xl'>{`${pageName} Form`}</h4>
      </section>
      {/*  */}
